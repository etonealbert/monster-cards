...
class BattleOfMonstersUITests: XCTestCase {
    ...
    func testIfElementsExist() throws {
        ...
        XCTAssertEqual(monsterBattleCardListElements.staticTexts.count, 2)
        XCTAssertTrue(monsterBattleCardListElements.staticTexts["Player"].waitForExistence(timeout: 2))
