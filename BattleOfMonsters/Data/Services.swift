...
protocol Services {
    func getMonsters(forResource: String, completion: @escaping (Result<[Monster], Error>) -> Void)
    func postBattle(body: [String : String?]?, completion: @escaping (Result<Battle, Error>) -> Void)
}
